...
POSTGRES_DB="${POSTGRES_DB:-subscription_manager}"
POSTGRES_USER="${POSTGRES_USER:-subscription_manager}"
...
find "$OUTPUT_DIRECTORY" -maxdepth 1 -type f -name 'subscription-manager-*.dump' -mtime "+$RETENTION_DAYS" -print0 |
